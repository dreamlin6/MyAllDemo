...
public class ActivityChangeBindingImpl extends ActivityChangeBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.changevm == variableId) {
            setChangevm((com.example.myaccount.viewmodel.UserChangeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setChangevm(@Nullable com.example.myaccount.viewmodel.UserChangeViewModel Changevm) {
    ...
    protected void executeBindings() {
        ...
        com.example.myaccount.viewmodel.UserChangeViewModel changevm = mChangevm;
