...
public class AdminFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adminViewModel = new ViewModelProvider(this).get(AdminViewModel.class);  //创建viewmodel
        fragmentAdminBinding.setAdminvm(adminViewModel); //设置绑定 XML和Adapter
    ...
    public void initAdapter() throws RemoteException {
        ...
        fragmentAdminBinding.userList.setLayoutManager(new GridLayoutManager(getContext(),1)); // 一列
